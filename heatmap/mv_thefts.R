...
#
# The following map shows car thefts in Chicago for the first six months of 2016.
# This data set was chosen for its size; it's relatively small, but also
# hetereogenous and provides good coverage throughout the city.
#
...
#
# The density estimates  were developed using R's `KernSmooth` package written by
# Matt Wand and Brian Ripley, based on the book "Kernel Smoothing" by Wand, M.P.
# and Jones, M.C. (1995).  The estimate used a gridsize of 100 by 100, and
# bandwiths of .0045 for Longitude and .0068 for Latitude.
#
# ## Narrative
#
# The map below shows both points and density estimates for auto thefts around
# the city.  **You can easily zoom in and scroll around to see more detail; use
# your mouse scroll wheel and click and drag to explore the map**.
#
# Although you may make an argument to experiment with a lower bandwidth, I think
# the levels look reasonable throughout much of the city.
...
# The map below is the exact same map as the one above, but zoomed into an area
# of interest.
#
# This zoomed in map shows some problems with the KDE.  The KDE looks reasonable
# in areas that are completely internal. However, when there's an area at the
# periphery that area seems to be artificially low.
#
# This area at Roosevelt and Austin Blvd is a relative hot spot, but it's level
# is only a 10. If you compare that with the point at Central and Madison, you'll
# see that a seemingly similar level of crime is reported as a 25.
